 ...
 */
    ...
    public void Iframe() {
        ...
        //➢ Son olarak sayfa basliginda iframe yazisinin gorunur oldugunu test ediniz.
        driver.switchTo().defaultContent();
      //driver.get(driver.getCurrentUrl()); -->sayfayi yeniledik
      //driver.navigate().refresh();//--> burda da refresh yaptik, yani bu 3 kodun birisiyle iframe den anasayfaya donebiliriz.
